...
Module UserModule
    ...
    Sub AddUser(Name As String, Username As String, Password As String, IsAdmin As Boolean)
        Dim Sql1 = "select name, username, password, is_admin from users where username=@Username"
        Dim Sql2 = "insert into users (name, username, password, is_admin) values (@Name, @Username, @Password, @IsAdmin)"
